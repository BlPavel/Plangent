...
interface AgentRuntime {
  ...
  sendToAgent(sessionId: string, mode: 'tmux' | 'pty', text: string): Promise<void>;
...
export function sendToAgent(sessionId: string, mode: 'tmux' | 'pty', text: string): Promise<void> {
  return getRuntime().sendToAgent(sessionId, mode, text);
}
