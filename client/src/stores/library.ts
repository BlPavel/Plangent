...
import { ref } from 'vue'
import { api } from '@/api'
import type { LibraryItem, LibraryItemType, LibraryScope } from '@/api/types'
...
export const useLibraryStore = defineStore('library', () => {
  ...
  return { items, loading, load, getItem, findMainId, create, update, remove, syncAll, getOverride, setOverride, deleteOverride }
})
